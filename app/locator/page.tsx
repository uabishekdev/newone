    ...
    <FarmProvider config={defaultConfig}>
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-orange-50 via-green-50 to-orange-100">
        ...
        <main className="flex-1 w-full flex flex-col items-center justify-center">
          <h1 className="text-5xl font-extrabold mb-6 text-orange-700">Store Locator</h1>
          <p className="text-lg text-gray-700 mb-8 max-w-xl text-center">Find the nearest store to buy our products. Coming soon!</p>
        </main>
        <Footer />
      </div>
    </FarmProvider>
